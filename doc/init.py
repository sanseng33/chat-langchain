        ...
        for row in reader:
            ...
            if corrid_search and message_search:
                try:
                    ...
                    new_dict={
                        'CORRID': corrid_search.group(1),
                        'prompt_con': prompt.format(**result_dict)
...
def extract_info_from_resp(csv_file_path):
    ...
    with open(csv_file_path, newline='', encoding='utf-8') as csvfile:
        ...
        for row in reader:
            ...
            message_search = text[text.index("resp:"):]
            if corrid_search:
                try:
...
if __name__ == "__main__":
    ...
    csv_file_name = 'D://data//target.csv'
